...
const executeJava = async (code, input = "") => {
    ...
    try {
        ...
        console.log("[2] Writing Java code...");
        ...
        console.log("[2] Main.java created");
        ...
        console.log("[7] Starting Java program...");
        ...
        console.log("[8] Java program started");
        ...
        const timeout = setTimeout(
            async () => {
                ...
                console.log(
                    "[TIMEOUT] Java program exceeded 3 seconds"
                );
